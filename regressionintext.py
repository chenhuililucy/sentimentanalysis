...
dir2= "/Users/lucy/Desktop/assortedcodes/builddic/intextvector2.csv"
...
#
        ...
        if float(row[4])!=0:
            l13.append((float(row[3]))/float(row[4]))
        else: 
            l13.append(".")
        l6.append(".")
...
z=zip(l1,l2,l3,l4,l5,l6,l7,l9,l11,l12,l13,l14,l15,l16,l17,l18,l19,l20,f)
csv2="/Users/lucy/Desktop/assortedcodes/vectorfinal(8).csv"
f_out2 = open(csv2, 'w')
wr2 = csv.writer(f_out2)
#wr2.writerow(["filename","year","cik","posl","negl","negneg","spreturns","roa","filedate"])
wr2.writerow(["filename","year","cik","internal","external","spreturns","roa","roat-1","roat+1","length","percwrds","epspi","epspx","mkvalt","prcc","csho","ceq","gic","filedate"])
