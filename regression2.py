...
dir2= "/Users/lucy/Desktop/assortedcodes/regression6.csv"
...
with open(dir2,"r") as posfile: 
    ...
    for row in records:
        ...
        l6.append(row[6])
        l8.append(float(row[9])/float(row[5]))
    posfile.close()
...
z=zip(l1,l2,l3,l4,l5,l8,l6,l7,f)
csv2="/Users/lucy/Desktop/assortedcodes/vectorfinal(2).csv"
f_out2 = open(csv2, 'w')
